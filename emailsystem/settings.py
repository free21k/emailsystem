...
SECRET_KEY = '5h0dvwv-5pptzbp7vtz5xd-stn^w#7&z%l_jk2#!^f_)_(h8x^'
...
INSTALLED_APPS = [
    ...
    'rest_framework.authtoken', #for rest_framework auth token
    'rest_framework', #for rest_framework
    'background_task',
]
...
STATICFILES_DIRS = (
    ...
    '/api/static/',	# garden App의 static 파일
)
